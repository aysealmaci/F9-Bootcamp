...
class AddPostScreenTwo extends StatefulWidget {
  const AddPostScreenTwo({Key? key}) : super(key: key);

  @override
  State<AddPostScreenTwo> createState() => _AddPostScreenTwoState();
}

class _AddPostScreenTwoState extends State<AddPostScreenTwo> {
  ...
  void _postAdd(
    ...
    String res = await StoreMethod().postAddTwo(name, _postText.text, uid, photoUser, _img!);
